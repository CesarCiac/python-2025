...
def home(request):
    return render(request,'acadapp/home.html')

def produto(request):
    produto = Produto.objects.all()
    return render(request,'acadapp/produto.html', {'produto':produto})

def contato(request):
    return render(request,'acadapp/contato.html')
...
def add_produto(request):
    if request.method == 'POST':
        ...
        form = ProdutoForm()
    return render(request, 'acadapp/add_produto.html', {'form': form})
...
def upload_profile(request):
    if request.method == 'POST':
        ...
        form = ProfileForm()
    return render(request, 'acadapp/upload_profile.html', {'form': form})
