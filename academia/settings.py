...
SECRET_KEY = 'django-insecure-6f4j@+kd4_fi8lu5lup_3=go7t&*6xlvm@28=6^w4f2)8%x*i('
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'acadapp/static') # Pasta do app
]
...
MEDIA_URL = '/ media/'    # URL para acessar arquivo
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')      # Pasta 
